...
import {
  Text as PDFText,
  View,
} from "@/engines/forme/lib/pdf-primitives";
import type { Style } from "@/engines/forme/lib/pdf-primitives";
...
export const TableCell = ({
  ...
  return <View style={styleArray as never}>{content}</View>;
};
...
export const TableRow = ({
  ...
  return (
    <View wrap={false} style={styleArray as never}>
      {processedChildren}
    </View>
  );
};
...
export const Table = ({
  ...
  const inner = <View style={styleArray as never}>{processedChildren}</View>;
